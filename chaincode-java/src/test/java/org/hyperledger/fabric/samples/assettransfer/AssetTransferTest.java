...
public final class AssetTransferTest {
    ...
    class DuplicateAssetTransaction {
        ...
        public void whenAssetExists() {
            ...
            Asset duplicateAsset = contract.DuplicateAsset(ctx, "asset1", "asset7", "Jack");
            assertThat(duplicateAsset).isEqualTo(new Asset("asset7", "blue", 45, "Jack", 60));
        ...
        public void whenAssetDoesNotExist() {
            ...
            Throwable thrown = catchThrowable(() -> {
                contract.DuplicateAsset(ctx, "asset1", "asset7", "Jack");
            });
